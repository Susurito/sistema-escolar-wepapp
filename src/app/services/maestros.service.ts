...
export class MaestrosService {
  ...
  //Validacion para el formulario maestro
  public validarMaestro(data: any, editar: boolean){
    ...
    if(!this.validatorService.required(data["materias_json"])){
      error["materias_json"] = "Debes seleccionar materias para poder registrate";
    }
  ...
  //TODO:Agregar el servicio puede usarse para que publico
